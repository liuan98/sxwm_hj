                    ...
                    <el-dialog
                        ...
                        <template v-if="!exportParams.is_show_download">
                            <div flex="cross:center">
                                ...
                                <span>选中{{choose_list.length == 0 ? '全部,共计'+ exportParams.goods_count : choose_list.length}}件商品，是否确认导出</span>
                            </div>
...
<!--                                <el-button @click="download" v-if="exportParams.percentage == 100" size="small"-->
            ...
            <div class="table-body">
                <app-search :tabs="tabs" :new-search="search" @to-search="toSearch"
                ...
                <el-table
                    ...
                    <el-table-column prop="virtual_sales" width="110" label="虚拟销量" sortable="false"></el-table-column> <el-table-column prop="sold" width="110" label="已出售量"></el-table-column>
