    ...
    <div slot="header" class="header-box">
        <el-breadcrumb separator="/">
            <el-breadcrumb-item><span style="color: #409EFF;cursor: pointer"
                                      @click="$navigate({r:'mall/plugin/index'})">插件中心</span></el-breadcrumb-item>
            <el-breadcrumb-item>插件详情</el-breadcrumb-item>
        </el-breadcrumb>
    </div>
    <el-card shadow="never" v-loading="loading" style="border:0">
        <template v-if="plugin">
            <div slot="header" class="form-body" flex="dir:left box:first cross:center">
                <div>
                    <img :src="plugin.pic_url" class="plugin-icon">
                </div>
                <div>
                    <div style="margin-bottom: 8px">{{plugin.display_name}}</div>
