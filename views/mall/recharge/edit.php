        ...
        <div class="form-body">
            <el-form :model="form" v-loading="loading" label-width="10rem" :rules="FormRules" ref="form">
                ...
                <el-form-item prop="pay_price">
                    ...
                    <el-input size="small" type="number" v-model="form.pay_price" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="" prop="send_price">
                    ...
                    <el-input size="small" type="number" v-model="form.send_price" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item prop="send_price">
                    ...
                    <el-input size="small" type="number" v-model="form.send_integral" autocomplete="off"></el-input>
                </el-form-item>
            </el-form>
        </div>
