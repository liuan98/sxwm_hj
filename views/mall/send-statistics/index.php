    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="table-body">
            <app-search
                ...
                <template slot="select">
                    <el-select size="small" popper-class="select-item" @change="getList" style="width: 160px" filterable v-model="search.type">
        ...
        <div class="table-body" style="padding: 20px">
            <el-table v-loading="loading" @sort-change="changeSort" :header-cell-style="{background:'#F3F5F6','color':'#303133',padding: '6px 0',fontWeight: '400'}" :data="list">
                ...
                <el-table-column prop="use_num" label="已使用数量" sortable='custom' :label-class-name="chooseProp == 'use_num' ? 'sort-active': ''">
                </el-table-column>
                <el-table-column prop="unuse_num" label="未使用数量" sortable='custom' :label-class-name="chooseProp == 'unuse_num' ? 'sort-active': ''">
                </el-table-column>
                <el-table-column prop="end_num" label="已失效数量" sortable='custom' :label-class-name="chooseProp == 'end_num' ? 'sort-active': ''">
                </el-table-column>
            </el-table>
