...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <app-header :url="url" :new-search="JSON.stringify(search)">整点秒杀</app-header>
        </div>
        ...
        <div class="table-body" style="padding: 20px">
            <el-table v-loading="loading" @sort-change="changeSort" :header-cell-style="{background:'#F3F5F6','color':'#303133',padding: '6px 0',fontWeight: '400'}" :data="list">
                <el-table-column prop="miaosha_time" width="250" label="秒杀时间">
                </el-table-column>
                <el-table-column prop="name" width="600" label="商品名称">
                ...
                <el-table-column prop="pay_price" label="支付金额" :label-class-name="prop == 'pay_price' ? 'sort-active': ''" sortable='custom'>
                </el-table-column>
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            getList() {
                ...
                request({
                    params: {
                        r: 'mall/miaosha-statistics/index',
                        page: this.page,
