    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
                        ...
                        <div style="height: 308px;border: 1px solid #ebeef5;padding:16px" flex="">
                            <div style="width: 20%; height: 100%;">
                                <p style="margin-bottom: 30px;" flex="main:left">
                                    网点名称：
                                    <span :class="global.sellerInf.branch ? 'blue-text' : 'decoration'">{{global.sellerInf.branch ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="margin-bottom: 30px;" flex="main:left">
                                    网点联系人：
                                    <span :class="global.sellerInf.name ? 'blue-text' : 'decoration'">{{global.sellerInf.name ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="margin-bottom: 30px;" flex="main:left">
                                    网点联系方式：
                                    <span :class="global.sellerInf.phone ? 'blue-text' : 'decoration'">{{global.sellerInf.phone ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="margin-bottom: 30px;" flex="main:left">
                                    网点地址：
                                    <span :class="global.sellerInf.address ? 'blue-text' : 'decoration'">{{global.sellerInf.address ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    网点邮编：
                                    <span :class="global.sellerInf.postcode ? 'blue-text' : 'decoration'">{{global.sellerInf.postcode ? '打印' : '不打印'}}</span>
                                </p>
                            </div>
                            <div style="width: 20%; height: 100%;">
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    订单号：
                                    <span :class="global.order.orderNumber ? 'blue-text' : 'decoration'">{{global.order.orderNumber ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    订单时间：
                                    <span :class="global.order.time ? 'blue-text' : 'decoration'">{{global.order.time ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    打印日期：
                                    <span :class="global.order.date ? 'blue-text' : 'decoration'">{{global.order.date ? '打印' : '不打印'}}</span>
                                </p>
                            </div>
                            <div style="width: 20%; height: 100%;">
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    商品序号：
                                    <span :class="global.goodsInf.serial ? 'blue-text' : 'decoration'">{{global.goodsInf.serial ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    商品名称：
                                    <span :class="global.goodsInf.name ? 'blue-text' : 'decoration'">{{global.goodsInf.name ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    规格：
                                    <span :class="global.goodsInf.attr ? 'blue-text' : 'decoration'">{{global.goodsInf.attr ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    数量：
                                    <span :class="global.goodsInf.number ? 'blue-text' : 'decoration'">{{global.goodsInf.number ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    小计：
                                    <span :class="global.goodsInf.univalent ? 'blue-text' : 'decoration'">{{global.goodsInf.univalent ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    货号：
                                    <span :class="global.goodsInf.article_number ? 'blue-text' : 'decoration'">{{global.goodsInf.article_number ? '打印' : '不打印'}}</span>
                                </p>
                            </div>
                            <div style="width: 20%; height: 100%;">
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    单位：
                                    <span :class="global.goodsInf.unit  ? 'blue-text' : 'decoration'">{{global.goodsInf.unit ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    订单金额：
                                    <span :class="global.goodsInf.amount ? 'blue-text' : 'decoration'">{{global.goodsInf.amount ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    优惠：
                                    <span :class="global.goodsInf.discount ? 'blue-text' : 'decoration'">{{global.goodsInf.discount ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    实付：
                                    <span :class="global.goodsInf.actually_paid ? 'blue-text' : 'decoration'">{{global.goodsInf.actually_paid ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    运费：
                                    <span :class="global.goodsInf.fare ? 'blue-text' : 'decoration'">{{global.goodsInf.fare ? '打印' : '不打印'}}</span>
                                </p>
                            </div>
                            <div style="width: 20%; height: 100%;">
                                <p flex="main:left">
                                    收货人昵称：
                                    <span :class="global.personalInf.nickname ? 'blue-text' : 'decoration'">{{global.personalInf.nickname ? '打印' : '不打印'}}</span>
                                </p>
                                <p flex="main:left">
                                    收货人姓名：
                                    <span :class="global.personalInf.name ? 'blue-text' : 'decoration'">{{global.personalInf.name ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;" flex="main:left">
                                    联系方式：
                                    <span :class="global.personalInf.payMethod ? 'blue-text' : 'decoration'">{{global.personalInf.payMethod ? '打印' : '不打印'}}</span>
                                </p>
                                <p flex="main:left">
                                    支付方式：
                                    <span :class="global.personalInf.phone ? 'blue-text' : 'decoration'">{{global.personalInf.phone ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;" flex="main:left">
                                    发货方式：
                                    <span :class="global.personalInf.shipMethod ? 'blue-text' : 'decoration'">{{global.personalInf.shipMethod ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;" flex="main:left">
                                    收货地址：
                                    <span :class="global.personalInf.address ? 'blue-text' : 'decoration'">{{global.personalInf.address ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;" flex="main:left">
                                    买家留言：
                                    <span :class="global.personalInf.leaveComments? 'blue-text' : 'decoration'">{{global.personalInf.leaveComments ? '打印' : '不打印'}}</span>
                                </p>
                                <p style="width:170px;" flex="main:left">
                                    商家自定义：
                                    <span :class="global.sellerInf.remark ? 'blue-text' : 'decoration'">{{global.sellerInf.remark ? '打印' : '不打印'}}</span>
                                </p>
                            </div>
                        </div>
                    </template>
                            ...
                            <div id="invoice"
                                ...
                                <div @click="showTab(3)"
                                    ...
                                    <div style="display: flex;border-bottom:1px solid #000000;"
                                        ...
                                        <div style="width: 6%;border-right: 1px solid #000000;height: 30px;line-height: 30px;padding-left: .5%;font-size:10px;"
                                             v-if="goodsInf.serial">序号
                                        </div>
                                        <div style="width: 26%;border-right: 1px solid #000000;height: 30px;line-height: 30px;padding-left: .5%;font-size:10px;"
                                             v-if="goodsInf.name"
                                        >商品名称
                                        </div>
                                        <div style="width: 18%;border-right: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;"
                                             v-if="goodsInf.attr">规格
                                        </div>
                                        <div style="width: 12%;border-right: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 10px;font-size:10px;"
                                             v-if="goodsInf.number">数量
                                        </div>
                                        <div style="width: 12%;border-right: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 10px;font-size:10px;"
                                             v-if="goodsInf.univalent">小计
                                        </div>
                                        <div style="width: 13%;border-right: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 10px;font-size:10px;"
                                             v-if="goodsInf.article_number">货号
                                        </div>
                                        <div style="width: 13%;height: 30px;line-height: 30px;padding-left: 10px;font-size:10px;"
                                             v-if="goodsInf.unit">单位
                                        </div>
                                    </div>
                                    <div style="display: flex;border-bottom: 1px solid #000000;"
                                         v-if="goodsInf.serial || goodsInf.name || goodsInf.attr || goodsInf.number || goodsInf.univalent || goodsInf.article_number || goodsInf.unit">
                                        <div style="width: 6%;word-wrap: break-word;border-right: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                             v-if="goodsInf.serial">
                                            <span>1</span>
                                        </div>
                                        <div style="width: 26%;word-wrap: break-word;border-right: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                             v-if="goodsInf.name">
                                            <span>男士羊毛衫</span>
                                        </div>
                                        <div style="width: 18%;word-wrap: break-word;border-right: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                             v-if="goodsInf.attr">
                                            <span
                                                    style="position: relative;transform:translate(-50%,-50%);width: calc(100% - 20px);word-wrap: break-word;"
                                            >默认</span>
                                        </div>
                                        ...
                                        <div style="width: 13%;word-wrap: break-word;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                             v-if="goodsInf.unit">
        ...
        <div id="print" v-show="false">
            <div v-for="(item) in printData"
                 :style="{padding: `0 ${mmConversionPx(printPar.left_right_margins) + 'px'}`, width: `${mmConversionPx(Number(printPar.left_right_margins) + Number(printPar.left_right_margins) + Number(printPar.stencil_width) + Number(printPar.border_width)+ Number(printPar.border_width)) + 'px'}`, pageBreakBefore: 'always'}">
                <div id="invoice"
    ...
    const app = new Vue({
        ...
        methods: {
                ...
                for (let i = 0; i < order_list.length; i++) {
                    ...
                    if (order_list[i].detailExpress.length > 0) {
                        ...
                        for (let j = 0; j < order_list[i].detail.length; j++) {
                            console.log(order_list[i].detail[j]);
                            detail.push({
            ...
            async save() {
                ...
                // let a = canvas.toDataURL("image/png").replace("image/png","image/octet-stream");
