        ...
        <div class="form-body">
            <el-form :model="form" label-width="150px" :rules="FormRules" ref="form">
                ...
                <el-form-item label="商品" prop="goods_id">
                    <el-autocomplete style="width: 100%" size="small" v-model="form.goods_name" value-key="name" :fetch-suggestions="querySearchAsync" placeholder="请输入内容" @select="clerkClick"></el-autocomplete>
                </el-form-item>
