...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <app-header :url="url" :new-search="JSON.stringify(search)">拼团</app-header>
        </div>
        ...
        <div class="table-body" style="padding: 20px">
            <el-table @sort-change="changeSort" v-loading="loading" :header-cell-style="{background:'#F3F5F6','color':'#303133',padding: '6px 0',fontWeight: '400'}" :data="list">
                ...
                <el-table-column prop="all_user" label="拼团人数" :label-class-name="prop == 'all_user' ? 'sort-active': ''" sortable='custom'>
                </el-table-column>
                <el-table-column prop="success_user" label="成团人数" :label-class-name="prop == 'success_user' ? 'sort-active': ''" sortable='custom'>
                </el-table-column>
                <el-table-column prop="success_100" label="成团率" :label-class-name="prop == 'success_100' ? 'sort-active': ''" sortable='custom'>
                </el-table-column>
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            getList() {
                ...
                request({
                    params: {
                        r: 'mall/pintuan-statistics/index',
                        page: this.page,
