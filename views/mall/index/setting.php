                    ...
                    <el-row>
                        <el-col :span="24">
                            ...
                            <div class="form-body">
                                ...
                                <!-- jambalaya添加订单核销佣金比例 -->
                                <el-form-item label="核销佣金比例" prop="hxpercent">
                                    <el-input v-model="ruleForm.setting.hxpercent"></el-input>
                                </el-form-item>
                                ...
                                <div style='background-color: #F3F5F6;padding: 30px;border-radius: 10px;'
                                    ...
                                    <div class="item-img">
                                        ...
                                        <app-image v-if='active_setting == "is_underline_price"' mode="aspectFill"
                                                   ...
                                                   style="margin-bottom: 20px" height="500" width="280"></app-image>
                                        <app-image mode="aspectFill" v-if='active_setting == "is_comment"'
                        ...
                        <el-col :span="24">
                            ...
                            <div class="form-body" v-if="ruleForm.setting.is_quick_navigation == '1'">
                                ...
                                <el-form-item>
                                    ...
                                    <el-button size="mini" @click="resetImg('small_app_pic')" class="reset" type="primary">恢复默认</el-button>
                                    <app-image style="width: 80px; height: 80px;"
            ...
            return {
                ...
                rules: {
                    ...
                    over_time: [
                     ...
                     //rate: [{required: true, message: '请填写利率。'}],
                    delivery_time: [
