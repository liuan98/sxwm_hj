                ...
                <div class="app-order-body">
                    ...
                    <div class="app-order-info" style="width: 8%">
                        <div>
                            ...
                            <div v-else-if="item.status == 2 && item.is_send == 0">待买家发货</div>
                            <div v-else-if="item.status == 2 && item.is_send == 1 && item.is_confirm == 0">
                                待卖家收货
                            </div>
                            <div v-else-if="item.status == 2 && item.type == 1 && item.is_confirm == 1 && item.is_refund == 0">
                                待卖家退款
                            </div>
                    ...
                    <!-- 申请理由 -->
                    <div class="app-order-info" style="width: 8%;text-align: left;padding: 20px;">
                        <div>
                            <el-tooltip effect="dark" placement="top">
                                <template slot="content">
                                    <div style="width: 320px;">{{item.remark == '' ? '无' : item.remark}}</div>
                                </template>
                                <app-ellipsis :line="2">{{item.remark == '' ? '无' : item.remark}}</app-ellipsis>
                            </el-tooltip>
                    ...
                    <div flex="main:center cross:center" class="app-order-info" style="width:18%;">
                        <el-tooltip class="item" effect="dark" content="同意" placement="top">
                            <img class="app-order-icon" src="statics/img/mall/pass.png" alt="" v-if="item.status == 1"
                                 @click="openDialog(item, agreeRefundVisible = true)">
                        </el-tooltip>
                        <!-- 拒绝 -->
                        <el-tooltip class="item" effect="dark" content="拒绝" placement="top">
                            <img class="app-order-icon" src="statics/img/mall/nopass.png" alt="" v-if="item.status == 1"
                        ...
                        <el-tooltip class="item" effect="dark" content="确认收货" placement="top">
                            <img class="app-order-icon" src="statics/img/mall/order/confirm.png" alt=""
                                 v-if="item.status == 2 && item.is_send == 1 && item.is_confirm == 0"
                                 @click="shouHuo(item)">
                        </el-tooltip>
