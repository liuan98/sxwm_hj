...
<div id="app" v-cloak>
    ...
    <el-card v-loading="loading" style="border:0" shadow="never" body-style="background-color: #f3f3f3;padding: 0 0;">
        <el-form :model="form" label-width="10.5rem" :rules="FormRules" ref="form">
                ...
                <el-tab-pane label="基础设置" name="first">
                    <div class="form-body">
                        ...
                        <el-form-item label="优惠券有效期" prop="expire_type">
                            <el-radio v-model="form.expire_type" label="1">领取后N天内有效</el-radio>
                            <el-radio v-model="form.expire_type" label="2">时间段</el-radio>
                        </el-form-item>
                        ...
                        <el-form-item label="有效期范围" v-if="form.expire_type == 2" prop="time">
                            <el-date-picker size='small' v-model="time" value-format="yyyy-MM-dd" type="daterange"
                        ...
                        <el-form-item prop="total_count">
                            <template slot='label'>
                                <span>可领取数量</span>
                                <el-tooltip effect="dark" content="可领取数量为0则无法领取或发放,-1为不限制张数"
                                            placement="top">
                                    <i class="el-icon-info"></i>
                                </el-tooltip>
                            </template>
