...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <app-header :url="url" :new-search="JSON.stringify(search)">股东分红</app-header>
        </div>
        ...
        <div class="table-body" style="padding: 20px">
            <el-table v-loading="loading" :header-cell-style="{background:'#F3F5F6','color':'#303133',padding: '6px 0',fontWeight: '400'}" :data="list">
                <el-table-column width="600" prop="name" label="等级名称">
                </el-table-column>
                <el-table-column prop="bonus_price" label="分红总额(元)">
                </el-table-column>
                <el-table-column prop="order_num" label="分红订单总数">
                </el-table-column>
                <el-table-column prop="user_num" label="股东人数">
            </el-table>
