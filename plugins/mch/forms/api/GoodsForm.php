...
class GoodsForm extends Model
{
    ...
    public function getDetail()
    {
        ...
        try {
            ...
            $res = $form->getAll();
            $salesCount = $this->getSales($res['virtual_sales'], $res['id']);
    ...
    private function getSales($virtualSales, $goodsId)
    {
        try {
        ...
        $goodObj = new \app\models\Goods();
        $goodObj->id = $goodsId;
        $goodsSales = $goodObj->getSales();
