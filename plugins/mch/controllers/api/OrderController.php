...
class OrderController extends ApiController
{
    ...
    public function actionPreview()
    {
        ...
        return $this->asJson($form->setEnableMemberPrice(false)->setEnableCoupon(false)
            ->setSign((new Plugin())->getName())->preview());
    }
    ...
    public function actionSubmit()
    {
        ...
        $form->form_data = \Yii::$app->serializer->decode(\Yii::$app->request->post('form_data'));
        return $this->asJson($form->setSupportPayTypes($mallPaymentTypes)->setEnableMemberPrice(false)->setEnableCoupon(false)
            ->setSign((new Plugin())->getName())->submit());
    }
}
