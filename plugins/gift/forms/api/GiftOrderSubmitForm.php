...
class GiftOrderSubmitForm extends \app\forms\api\order\OrderSubmitForm
{
    ...
    public function setPluginData()
    {
        ...
        $this->setEnablePriceEnable(false)
            ->setSupportPayTypes($setting ? $setting['payment_type'] : "['online_pay']");
        return $this;
    }
    ...
    public function submit()
    {
        ...
        $dataArr = [
            ...
            'token' => $token,
            'sign' => $this->sign,
            'supportPayTypes' => is_array($setting['payment_type']) ? $setting['payment_type'] : json_decode($setting['payment_type'], true),
