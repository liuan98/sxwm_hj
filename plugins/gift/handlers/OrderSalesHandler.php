    ...
    protected function giveIntegral()
    {
        try {
            ...
            if ($this->orderDetail->goods->give_integral_type == 1) {
                $integral += ($this->orderDetail->goods->give_integral * $this->orderDetail->num);
            } else {
                $integral += (intval($this->orderDetail->goods->give_integral * $this->orderDetail->total_price / 100));
            }
            if ($integral > 0) {
