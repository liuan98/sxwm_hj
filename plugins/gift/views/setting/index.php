                    ...
                    <el-tab-pane label="基础设置" class="form-body" name="first">
                        <div class="app-setting">
                            ...
                            <el-form-item label="是否开启邮件提醒">
                                ...
                                <span class="ml-24 red">注：必须在“
                                    <el-button type="text" @click="$navigate({r:'mall/sms/setting'}, true)">系统管理=>邮件通知</el-button>
                                    ”中开启，才能使用
                                </span>
                            </el-form-item>
                            ...
                            <el-form-item label="是否开启打印">
                                ...
                                <span class="ml-24 red">注：必须在“
                                    <el-button type="text" @click="$navigate({r:'mall/sms/setting'}, true)">系统管理=>小票打印</el-button>
                                    ”中开启，才能使用
                                </span>
                            </el-form-item>
                            ...
                            <el-form-item label="发货方式" prop="send_type" >
                                ...
                                <el-checkbox-group v-model="form.send_type" size="mini">
                                    <el-checkbox label="express" size="mini">快递配送</el-checkbox>
                                    <el-checkbox label="offline" size="mini">到店自提</el-checkbox>
                                    <el-checkbox label="city" size="mini">同城配送</el-checkbox>
                                </el-checkbox-group>
                            </el-form-item>
