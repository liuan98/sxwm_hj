...
<div id="app" v-cloak>
        ...
        <div class="table-body">
            ...
            <el-table v-loading="loading" border :data="list" style="width: 100%;margin-bottom: 15px">
                ...
                <el-table-column align="center" width='120' prop="status" label="状态">
                    <template slot-scope="scope">
                        <el-tooltip class="item" effect="dark" v-if="scope.row.type == 0" content="进行中" placement="top">
                ...
                <el-table-column width='220' label="操作">
                    <template slot-scope="scope">
                        <el-button circle size="mini" type="text" @click="about(scope.row)">
                            <el-tooltip class="item" effect="dark" content="参与详情" placement="top">
                                <img src="statics/img/mall/detail.png" alt="">
                            </el-tooltip>
                        </el-button>
                        <el-button circle size="mini" type="text" v-if="scope.row.people_num == 0" @click="edit(scope.row)">
    ...
    <el-dialog title="创建活动" :visible.sync="add" width="30%">
