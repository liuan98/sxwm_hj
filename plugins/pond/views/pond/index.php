    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div style="display: flex;">
            <div class="preview" v-loading=loading>
                <app-image style="border:2px solid #F4F5F6" src="<?= \app\helpers\PluginHelper::getPluginBaseAssetsUrl() ?>/img/pond.png" width='375px'
            ...
            <el-card shadow="never" class="setting-menu" body-style="padding:2%;padding-right: 0">
                <div slot="header">
                    <span>奖品设置</span>
                </div>
                <div class="text item" v-loading=loading>
                            ...
                            <el-tab-pane :label="item.name" :name="item.id" v-for="item in prize" :key="item.id">
                                <div style="margin-top:25px">
                                    ...
                                    <el-form-item label="库存" prop="stock" v-if="form.type != 5">
                                        <el-input style='max-width: 180px' size="small" type="number" v-model="form.stock"
                                                  autocomplete="off"></el-input>
                                    </el-form-item>
                                </div>
                            </el-tab-pane>
                    ...
                    <el-button class="button-item" type="primary" size="small" :loading=btnLoading @click="onSubmit">保存</el-button> 
                </div>
            </el-card>  
        </div>
    </el-card>
