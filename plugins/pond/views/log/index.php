...
<div id="app" v-cloak>
    ...
    <!--             <el-form-item>
            ...
            <div flex="box:last cross:center">
                ...
                <div>
                    <el-pagination :page-size="20" v-if="pagination" style="display: inline-block;float: right;" background @current-change="pageChange" layout="prev, pager, next" :total="pagination.total_count">
                    </el-pagination>
                </div>
            </div>        
        </div>
