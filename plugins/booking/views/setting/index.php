            ...
            <el-form :model="form" label-width="150px" :rules="FormRules" ref="form">
                <el-tabs v-model="activeName">
                    <el-tab-pane label="基础设置" class="form-body" name="first">
                        <el-form-item label="是否显示分类" prop="is_cat">
                            <el-switch
                                    v-if="loading"
                                    v-model="form.is_cat"
                                    :active-value="1"
                        ...
                        <app-setting v-model="form" :is_territorial_limitation="false" :is_send_type="false"></app-setting>
                    </el-tab-pane>
                    <el-tab-pane label="表单设置" class="form-body" name="second">
                        <el-form-item label="表单状态" prop="is_form">
                            <el-switch
                                    v-if="loading"
                                    v-model="form.is_form"
                                    :active-value="1"
                                    :inactive-value="0">
                            </el-switch>
                        </el-form-item>
                        <el-form-item v-if="form.is_form == 1" label="表单设置" prop="selectedOptions">
                            <app-form :is_date_range="true" :is_time_range="true" :value.sync="form.form_data"></app-form>
                        </el-form-item>
                    </el-tab-pane>
                    <el-tab-pane label="自定义海报" class="form-body" name="three" style="background:none;padding:0">
