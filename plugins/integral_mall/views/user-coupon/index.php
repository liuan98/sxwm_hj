    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="table-body">
            <div class="input-item">
                <el-input size="small" @keyup.enter.native="search" placeholder="请输入用户名搜索" v-model="keyword" clearable @clear="search">
            ...
            <el-table v-loading="loading" border :data="list" style="width: 100%;margin-bottom: 15px">
                ...
                <el-table-column width='300' prop="nickname" label="用户">
                    <template slot-scope="scope">
                ...
                <el-table-column width='180' prop="userCoupon" label="最低消费金额（元）">
                    <template slot-scope="scope">
                        <span>{{scope.row.integralMallCoupon.coupon.min_price}}元</span>
                    </template>
                </el-table-column>
                <el-table-column width='180' prop="sub_price" label="优惠方式">
                    <template slot-scope="scope">
                        <span>优惠:{{scope.row.integralMallCoupon.coupon.sub_price}}元</span>
                    </template>
                </el-table-column>
                <el-table-column width='150' prop="sub_price" label="兑换所需积分">
                    <template slot-scope="scope">
                        <span>{{scope.row.integralMallCoupon.integral_num}}积分</span>
                    </template>
                </el-table-column>
                <el-table-column width='120' prop="sub_price" label="售价">
                    <template slot-scope="scope">
                        <span>{{scope.row.integralMallCoupon.price}}元</span>
                    </template>
                </el-table-column>
