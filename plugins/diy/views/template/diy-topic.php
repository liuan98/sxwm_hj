                ...
                <template v-else>
                    ...
                    <el-form-item label="分类列表" v-if="data.cat_show">
                        <el-card shadow="never" class="topic-edit-options" style="margin-bottom: 24px" v-for="(cat, catIndex) in data.list"
                            ...
                            <div @click="selectCat(catIndex)">
                                ...
                                <div flex="box:first" v-else>
                                    ...
                                    <div>
                                        <app-dialog-select url="mall/topic/index" :multiple="true" @close="topicShow = false"
                                                           @selected="selectTopic" :extra-search="{type: cat.cat_id}"
                                                           title="选择专题" list-key="title" :display="topicShow" style="height: 0;">
                                        </app-dialog-select>
                                        <el-button size="mini" @click="topicShow = true">添加专题</el-button>
                        ...
                        <app-dialog-select url="mall/topic-type/index" :multiple="true" @selected="selectCatList"
                                           title="选择分类" :display="catShow" @close="catShow = false" style="height: 0;">
                        </app-dialog-select>
                        <el-button size="mini" @click="catShow = true">添加分类</el-button>
                    </el-form-item>
                    <el-form-item label="专题列表" v-else>
                        <app-dialog-select url="mall/topic/index" :multiple="true" @selected="selectTopic" @close="topicShow = false"
                                           title="选择专题" list-key="title" :display="topicShow" style="height: 0;">
                        </app-dialog-select>
                        <el-button size="mini" @click="topicShow = true">添加专题</el-button>
