                ...
                <div :style="'background-color:'+ data.backgroundColor+';padding:'+data.padding+'px 0;background-image:url('+data.backgroundPicUrl+');background-size:'+data.backgroundWidth+'% '+data.backgroundHeight+'%;background-repeat:'+repeat+';background-position:'+position">
                    <div v-for="(item,index) in list" :flex="data.style==3?'wrap:wrap':'dir:left'" :style="'margin-top:'+(index == 0 ? '0':data.marginBottom)+'px;padding: 0px '+data.inputPadding+'px;'">
                        ...
                        <div v-else-if="item.key =='radio' || item.key =='checkbox'" flex="dir:left wrap:wrap cross:center">
                            <div class="radio-item border" :style="'margin-bottom:'+ data.marginBottom +'px'" v-for="row in item.list">{{row.label}}</div>
                        </div>
        ...
        <div class="diy-component-edit">
            ...
            <el-form label-width="100px" @submit.native.prevent>
                ...
                <el-form-item label="输入框边距">
                    <el-slider v-model="data.inputPadding" style="float: left;width: 95%" :max="50" show-input></el-slider>
                    <div style="float: right">px</div>
                </el-form-item>
                <el-form-item label="输入框间距">
                    <el-slider v-model="data.marginBottom" style="float: left;width: 95%" :max="50" show-input></el-slider>
                    <div style="float: right">px</div>
                </el-form-item>
                <el-form-item label="输入框圆角">
                    <el-slider v-model="data.radius" style="float: left;width: 95%" :max="data.height/2" show-input></el-slider>
                    <div style="float: right">px</div>
                </el-form-item>
                <el-form-item label="填充颜色">
                    <div class="input-color" flex="dir:left cross:center">
                        <el-color-picker :change="changeColor" size="small" v-model="data.inputBackground"></el-color-picker>
                        <el-input size="small" style="width: 80px;margin-right: 25px;" v-model="data.inputBackground"></el-input>
                        <div style="margin-right: 12px;color: #606266">边框颜色</div>
                        <el-color-picker :change="changeColor" size="small" v-model="data.inputBorder"></el-color-picker>
                ...
                <el-form-item label="名称颜色">
                    <div class="input-color" flex="dir:left cross:center">
                        ...
                        <el-input size="small" style="width: 80px;margin-right: 25px;" v-model="data.inputLabel"></el-input>
                ...
                <el-form-item label="文本颜色">
                    <div class="input-color" flex="dir:left cross:center">
                        ...
                        <el-input size="small" style="width: 80px;margin-right: 25px;" v-model="data.inputText"></el-input>
                    </div>
                </el-form-item>
                <hr>
                <div style="margin-bottom: 20px">提交按钮样式</div>
                <el-form-item label="按钮高度">
                    <el-slider v-model="data.buttonHeight" style="float: left;width: 95%" :max="160" show-input></el-slider>
                    <div style="float: right">px</div>
                </el-form-item>
                <el-form-item label="按钮边距">
                    <el-slider v-model="data.buttonPadding" style="float: left;width: 95%" :max="50" show-input></el-slider>
                    <div style="float: right">px</div>
                </el-form-item>
                <el-form-item label="按钮上间距">
                    <el-slider v-model="data.buttonMargin" style="float: left;width: 95%" :max="50" show-input></el-slider>
                    <div style="float: right">px</div>
                </el-form-item>
                <el-form-item label="按钮圆角">
                    <el-slider v-model="data.buttonRadius" style="float: left;width: 95%" :max="data.buttonHeight/2" show-input></el-slider>
                    <div style="float: right">px</div>
                </el-form-item>
                ...
                <el-form-item label="填充颜色">
                    <div class="input-color" flex="dir:left cross:center">
                        <el-color-picker :change="changeColor" size="small" v-model="data.borderBackground"></el-color-picker>
                        <el-input size="small" style="width: 80px;margin-right: 25px;" v-model="data.borderBackground"></el-input>
                        <div style="margin-right: 12px;color: #606266">边框颜色</div>
                        <el-color-picker :change="changeColor" size="small" v-model="data.borderBorder"></el-color-picker>
                ...
                <el-form-item label="文本颜色">
                    <div class="input-color" flex="dir:left cross:center">
                        ...
                        <el-input size="small" style="width: 80px;margin-right: 25px;" v-model="data.borderText"></el-input>
                    </div>
                </el-form-item>
                <hr>
