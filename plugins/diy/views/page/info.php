...
<div id="app" v-cloak>
    ...
    <el-dialog title="表单信息" :visible.sync="dialogTableVisible" width="20%">
        <el-table :data="detail">
            <el-table-column property="name" label="标签名称"></el-table-column>
            <el-table-column property="value" label="填写内容">
                <template slot-scope="scope">
                    <img @click="toLook(scope.row.value[0])" v-if="scope.row.key=='img_upload' && scope.row.value" style="height: 100px;width: 100px;cursor: pointer" :src="scope.row.value[0]" alt="">
