    ...
    public function search()
    {
        ...
        foreach ($list as &$item) {
            ...
            switch ($up_info->type) {
                ...
                case 1:
                    if ($item['condition'] > 0 && $share->all_children >= $item['condition']) {
                        $item['is_up'] = 1;
                    }
                    break;
                case 2:
                    if ($item['condition'] > 0 && $share->total_money >= $item['condition']) {
                        $item['is_up'] = 1;
                    }
                    break;
                case 3:
                    ...
                    break;
                case 4:
                    if ($item['condition'] > 0 && $share->all_order >= $item['condition']) {
                        $item['is_up'] = 1;
                    }
                    break;
                case 5:
                    if ($item['condition'] > 0 && $share->all_money >= $item['condition']) {
                        $item['is_up'] = 1;
                    }
                    break;
            }
