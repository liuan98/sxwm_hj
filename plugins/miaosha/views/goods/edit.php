    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 0 0;">
        <div slot="header">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><span style="color: #409EFF;cursor: pointer" @click="$navigate({r:'plugin/miaosha/mall/goods/index'})">秒杀商品</span></el-breadcrumb-item>
    ...
    const app = new Vue({
        ...
        data() {
            return {
                ...
                url: 'plugin/miaosha/mall/goods/edit',
