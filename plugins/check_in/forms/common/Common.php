...
class Common extends Model
{
    ...
    public function getAwardConfigTotal($user)
    {
        ...
        $query = CheckInSign::find()->alias('us')->where(['us.user_id' => $userId])->select('us.day, us.id');
    ...
    public function getDay($month, $user)
    {
        ...
        $checkInAll = $this->getCheckInDayByMonth($month, $user);
        $checkInDay = [];
