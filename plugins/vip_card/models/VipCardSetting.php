...
class VipCardSetting extends \app\models\ModelActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['mall_id', 'is_vip_card', 'is_share', 'is_sms', 'is_mail', 'is_agreement', 'share_type', 'is_delete', 'is_buy_become_share'], 'integer'],
            [['payment_type', 'agreement_content', 'form', 'share_level'], 'string'],
