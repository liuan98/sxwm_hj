            ...
            <el-tabs class="tabs" v-model="activeName">
                <el-tab-pane label="基础配置" name="first">
                    <div class="form-body">
                        ...
                        <el-form-item label="会员卡适用插件" prop="rules">
                            <el-checkbox-group v-model="detail.rules" size="mini">
                                <el-checkbox v-for="item in plugins_list" :label="item.sign" size="mini">{{item.name}}</el-checkbox>
                            </el-checkbox-group>
                        </el-form-item>
                                                ...
                                                <el-form-item class="user-label" label="未购买用户" prop="buy_user">
                                                    ...
                                                    <el-form-item label="文字" prop="buy_text">
                                                        <div flex="dir:left cross:center">
                                                            <el-input maxlength="15" style="margin-left: 10px;width: 240px" size="small" v-model="form.buy_big" placeholder="大标题（字符限制15）"></el-input>
                                            ...
                                            <el-form label-position="left">
                                                <el-form-item class="user-label" label="已购买用户" prop="renew_user">
                                                    ...
                                                    <el-form-item label="文字" prop="renew_text">
                                                        <div flex="dir:left cross:center">
                                                            <el-input maxlength="15" style="margin-left: 10px;width: 240px" size="small" v-model="form.renew_text" placeholder="标题（字符限制15）"></el-input>
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            openScroll(e) {
                ...
                let num = 1;
                let number = 0;
                console.log(that.form.vip_icon_list)
        ...
        created() {
            ...
            request({
                params: {
                    r: 'plugin/vip_card/mall/setting/plugins'
                },
                method: 'get'
            }).then(e => {
                if(e.data.code == 0) {
                    this.plugins_list = e.data.data;
                }
            })
        },
    });
