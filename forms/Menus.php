...
//                    ],
    ...
    public static function setExtraMenu($item, $pluginMenus, $platformMenus, $statisticsMenus, $isPluginMenus)
    {
        ...
        if (isset($item['key']) && $item['key'] == 'statistics') {
            $statistics = [
                'name' => '插件统计',
                'route' => '',
                'children' => $statisticsMenus
            ];
            $item['children'][] = $statistics;
            $item['children'] = array_merge($item['children'], [
                [
                    'name' => '积分收支',
